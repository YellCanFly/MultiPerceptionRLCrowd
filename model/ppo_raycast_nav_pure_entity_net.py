...
class ActorNetwork(nn.Module):
    def __init__(self, lr, ray_vec_dims, agent_vec_dims, weight_vec_dims, state_img_dims, action_dims,
        ...
        self.model_entity = nn.Sequential(
            nn.Linear(self.ray_vec_dims + self.agent_vec_dims + 1, self.fc1_dims),
    ...
    def forward(self, state_vec, state_img):
        ...
        entity_feature = self.model_entity(
            torch.cat((ray_state, agent_state, weight_state[..., 0].unsqueeze(-1)), dim=-1))
...
if __name__ == '__main__':
    ...
    pretrained_entity_model_path = '../checkpoint_ppo/2024_11_19_10_39_0'
    rl_model.load_models(pretrained_entity_model_path)
    rl_model.save_models_entity(pretrained_entity_model_path)
