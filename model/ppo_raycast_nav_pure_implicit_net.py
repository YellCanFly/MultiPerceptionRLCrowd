...
class ActorNetwork(nn.Module):
    def __init__(self, lr, ray_vec_dims, agent_vec_dims, weight_vec_dims, state_img_dims, action_dims,
        ...
        self.model_implicit = nn.Sequential(
            nn.Linear(self.fc2_dim_img + self.agent_vec_dims + 1, self.fc1_dims),
    ...
    def forward(self, state_vec, state_img):
        ...
        implicit_feature = self.model_implicit(
            torch.cat((img_feature, agent_state, weight_state[..., 1].unsqueeze(-1)), dim=-1))
...
if __name__ == '__main__':
    ...
    pretrained_pure_implicit_model_path = '../checkpoint_ppo/2024_11_19_10_39_0'
